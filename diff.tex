...
%DIF DEL old.tex   Mon Feb 19 15:06:55 2018
%DIF ADD new.tex   Mon Feb 19 15:02:17 2018
\usepackage{ tipa }
\usepackage{ amssymb }
\usepackage{amsmath} 
...
% 1st. author
\alignauthor
\DIFdelbegin \DIFdel{Mukesh Saini}\DIFdelend \DIFaddbegin \DIFadd{Nitin Gandhi}\DIFaddend \\
       \affaddr{Dept. of Computer Science}\\
       \DIFdelbegin %DIFDELCMD < \affaddr{\small{National University of Singapore}}%%%
\DIFdelend \DIFaddbegin \affaddr{\small{IIT Ropar}}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \email{mksaini@comp.nus.edu.sg}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \email{2016csb1045@iitrpr.ac.in}
\DIFaddend % 3rd. author
\alignauthor 
\DIFdelbegin \DIFdel{Raghudeep Gadde}\DIFdelend \DIFaddbegin \DIFadd{Paras Kumar}\DIFaddend \\
       \affaddr{Dept. of ECE}\\
       \DIFdelbegin %DIFDELCMD < \affaddr{\small{National University of Singapore}}%%%
\DIFdelend \DIFaddbegin \affaddr{\small{IIT Ropar}}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \email{elerdg@nus.edu.sg}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \email{2016csb1047@iitrpr.ac.in}
\DIFaddend \and  % use '\and' if you need 'another row' of author names
% 4th. author
\alignauthor 
\DIFdelbegin \DIFdel{Shuicheng Yan}\DIFdelend \DIFaddbegin \DIFadd{Parul}\DIFaddend \\
       \affaddr{Dept. of ECE}\\
       \DIFdelbegin %DIFDELCMD < \affaddr{\small{National University of Singapore}}%%%
\DIFdelend \DIFaddbegin \affaddr{\small{IIT Ropar}}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \email{eleyans@nus.edu.sg}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \email{2016csb1048@iitrpr.ac.in}
\DIFaddend % 5th. author
\alignauthor 
\DIFdelbegin \DIFdel{Wei Tsang Ooi}\DIFdelend \DIFaddbegin \DIFadd{Ankan Bal}\DIFaddend \\
       \affaddr{Dept. of Computer Science}\\
      \DIFdelbegin %DIFDELCMD < \affaddr{\small{National University of Singapore}}%%%
\DIFdelend \DIFaddbegin \affaddr{\small{IIT Ropar}}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \email{ooiwt@comp.nus.edu.sg}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \email{2016csb1031@iitrpr.ac.in}
\DIFaddend % 6th. author
}
...
email: {\texttt{jsmith@affiliation.org}}) and Julius 
...
\DIFaddbegin \DIFadd{I am a new sentence.
}\DIFaddend In this section, we first enumerate the design principles \includegraphics[scale=1]{two.pdf}\\
that we
...
\DIFaddbegin \DIFadd{I am a new sentence.
}\DIFaddend Shakiness is calculated based on the method described in \cite{salas:four}.
...
\begin{tabular}{ll}
\hline
\multicolumn{1}{l|}{A} & Quality of video editing                                                                                                         \\ \hline
\multicolumn{1}{l|}{B} & Visual quality of video                                                                                                          \\ \hline
\multicolumn{1}{l|}{C} & Camera positioning in the video                                                                                                  \\ \hline
\multicolumn{1}{l|}{D} & \begin{tabular}[c]{@{}l@{}}Interestingness (does video editing makes an interesting\\ overview of the performance?)\end{tabular} \\ \hline
E                      & \begin{tabular}[c]{@{}l@{}}Overall quality (how likely you will recommend the video to\\ a friend?)\end{tabular}                
\end{tabular}
\end{table}
...
\subsection{Dataset}
\DIFaddbegin \DIFadd{I am a new sentence.
}\DIFaddend The main application of the proposed framework is to combine
...
\DIFaddbegin \DIFadd{I am a new sentence.
}\DIFaddend In the user study, we ask the users to watch the mashups created
...
\DIFaddbegin \DIFadd{I am a new sentence.
}\DIFaddend User ratings for overall video quality are shown in the Figure 8.
...
\DIFaddbegin \DIFadd{I am a new sentence.
}\DIFaddend The MoViMash framework takes automatic mashup creation meth-
